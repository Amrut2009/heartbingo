Feature: Login Functionality
  ...
  Scenario: User should be able to login with valid Credentials
    ...
    And   User enters valid Username "patelrutvisha@gmail.com"
    And   User enters valid Password "charm123!"
  ...
  Scenario: User should not be able to login with invalid Credentials
    When User clicks on Accept Cookies
    When  User clicks on Login Link
    And   User enters Invalid Username "patelrutvisha9@gmail.com"
    And   User enters Invalid Password "rutu12345!"
    And   User clicks on Login Button
